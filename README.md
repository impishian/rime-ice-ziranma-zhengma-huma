...
雾凇里已整合了“部件拆字”、“以词定字”的功能。输入同音的单字时，可减少翻页。
...
| CJK-I | 15.1 | 2023-09 | 622字。截止 CJK-I，共有 97681 CJK 字，加上非 CJK 的，共有约15万 |
...
打古文或古籍录入，可用大字集的郑码打单，并要安装大字符集的字体（比如：天珩的字体）。

打繁体字，偶尔用注音（若要符合港台习惯，则最好另找更好的注音词库）。用广东话打字，偶尔用粤拼。
