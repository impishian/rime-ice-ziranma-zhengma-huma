# 雾凇拼音加搜狗词库和多种拆字辅码 + 双辅自然码 + CJK-E郑码 + CJK-I虎码

【TLDR】

将自己常用的输入法放到一套 rime 配置里。记述了定制整合过程。树形的 “文件列表” 部分，记述了在雾凇基础上增删改的文件。
...
[鹤形辅码](https://flypy.cc/#/tu) 的字根和规则，梳理似乎得有规律些，字根也多些。可是鹤形主要是8105个规范汉字，大概翻盖日常打字99.9%的字。自然码辅码覆盖 CJK 越两万的字。
